<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublishItemsManagement.aspx.cs" Inherits="PublishItemsManagement" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2" colspan="3"><strong>Publisher Pannel: Publish Management</strong></td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/PublisherPannel.aspx">Publisher Pannel</asp:HyperLink>
&nbsp;|
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/PublishItems.aspx">Supply Items</asp:HyperLink>
